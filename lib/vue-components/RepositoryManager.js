            ...
            <div class="file-list-box">
                ...
                <ul class="file-list">
                    ...
                    <li v-for="file in files" 
                        ...
                        <button class="edit-btn" @click.stop="editFile(file)">✏️</button>
                        <span class="file-name">{{ file }}</span>
                        <button class="delete-btn" @click.stop="deleteFile(file)">🗑️</button>
                    </li>
                </ul>
            </div>
            ...
            <div class="preview-box">
                ...
                <div class="preview-content">
                    ...
                    <div v-else-if="isEditing">
                        <div v-if="!currentFile" style="margin-bottom: 15px;">
    ...
    methods: {
        ...
        async saveFile() {
            ...
            try {
                ...
                this.renderedContent = this.renderMarkdown(this.editContent)
                this.isEditing = false
            } catch (error) {
